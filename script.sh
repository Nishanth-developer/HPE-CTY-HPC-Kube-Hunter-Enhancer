...
# git clone https://github.com/Nishanth-developer/HPE-CTY-2023-Kube-Hunter.git
#
# # Copy the contents of kube-hunter-enhancer directory to the target directory
# cp -r HPE-CTY-2023-Kube-Hunter/kube-hunter-enhancer/* ~/Documents/target_directory/
#
